            ...
            <form data-action="<?=$router->route('createUser.user')?>" id="createUserForm" class="p-4">
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" class="form-control bg-dark-secondary border-0 p-3 text-white" placeholder="Seu nome">
                        </div>
                        <div class="mb-4">
                            <label class="form-label text-white fw-bold">E-mail</label>
                            <input type="email" name="email" id="email" class="form-control bg-dark-secondary border-0 p-3 text-white" placeholder="exemplo@email.com">
                        </div>
                        <div class="mb-4">
                            <label class="form-label text-white fw-bold">Data de nascimento</label>
                            <input type="date" name="birthDate" id="birthDate" class="form-control  bg-dark-secondary border-0 p-3 text-white">
                        </div>
                        <div class="mb-4">
                            <div class="row g-3">
                                <div class="col">
                                <label class="form-label text-white fw-bold">Senha</label>
                                    <input type="password" name="password" id="password" class="form-control bg-dark-secondary border-0 p-3 text-white" placeholder="Sua senha">
                                </div>
                                <div class="col">
