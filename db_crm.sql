...
LOCK TABLES `tbl_history_protect` WRITE;
...
insert  into `tbl_task`(`id_task`,`fk_status`,`fk_picture`,`fk_user`,`name_task`,`account_task`,`date_task`,`order_task`,`fk_user_received`) values (46,28,27,1,'Tarefa 1','teste','2022-02-16 20:25:34',0,1);
...
insert  into `tbl_task_history`(`id_task`,`fk_status`,`fk_picture`,`fk_user`,`name_task`,`account_task`,`date_task`,`order_task`,`fk_user_received`) values (47,29,27,1,'Tarefa 2','asa','2022-02-16 20:32:34',0,1);
